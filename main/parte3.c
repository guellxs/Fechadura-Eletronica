...
//-----------------------------------------------------------------------------------------------------------------------
    ...
    void reset(){
        posicao = 0;
        for(int i=0; i<4; i++)senha_digitada[i]=0;
        escreve_lcd(2, 0, "____");
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////arrombamento
            ...
            if(IN(5) == 1) { fimdecurso = true;
            }
            else { fimdecurso = false; 
            }
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////contagem
                for(int j = 0; j < 5; j++)//fim de cruso
                {
                escreve_lcd(1, 0, "Arrombamento");

                if (som==0) entradas = io_le_escreve(0b10000000);
                else entradas = io_le_escreve(0b00000000); 
                    contbuzzer++;
                    if(contbuzzer==10){som =! som;contbuzzer = 0;}
                }
            }
